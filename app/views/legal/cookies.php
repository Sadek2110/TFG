        ...
        <table style="width:100%;border-collapse:collapse;margin:16px 0;">
            ...
            <tbody>
                <tr style="border-bottom:1px solid var(--fp-glass-border);">
                    <td style="padding:12px 8px;font-size:14px;">FPSESSID</td>
                    <td style="padding:12px 8px;font-size:14px;">Cookie de sesión técnica para mantener la autenticación</td>
                    <td style="padding:12px 8px;font-size:14px;">Sesión</td>
                </tr>
                <tr style="border-bottom:1px solid var(--fp-glass-border);">
                    <td style="padding:12px 8px;font-size:14px;">_csrf</td>
                    <td style="padding:12px 8px;font-size:14px;">Token de seguridad contra falsificación de peticiones</td>
                    <td style="padding:12px 8px;font-size:14px;">Sesión</td>
                </tr>
            </tbody>
        </table>
