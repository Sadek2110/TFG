...
- Desarrollo en el lado del cliente → El JS del proyecto, la modificacion del DOM, AJAX, llamadas a APIs, eventos, cookies…
- Despliegue → La parte del despliegue del proyecto.
- Seguridad → Toda la parte de la seguridad del proyecto (Tokens, sesiones…).

Este proyecto lo tengo que presentar para cada uno de los profesores, mas que la idea, tengo que explicar para cada profesor lo relevante de su asignatura en este proyecto.